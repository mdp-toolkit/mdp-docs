...
layer1 = bimdp.hinet.CloneBiLayer(MPerceptronBiNode(input_dim=3),
                                  n_nodes=6, use_copies=True, node_id="layer_1")
layer_flownode1 = bimdp.hinet.BiFlowNode(switchboard1 + layer1)
switchboard2 = bimdp.hinet.BiSwitchboard(input_dim=6, connections=range(6),
                                         node_id="switchboard_2")
layer2 = bimdp.hinet.CloneBiLayer(MPerceptronBiNode(input_dim=3),
